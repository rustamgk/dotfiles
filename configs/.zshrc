...
export PATH="$HOME/.local/bin/":/usr/local/bin:/usr/local/sbin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/golang/bin:$DOTNET_ROOT:$DOTNET_ROOT/tools
export PATH="$PATH:/mnt/c/Users/rusta/AppData/Local/Programs/Microsoft VS Code/bin"
...
# ----------------------------------------
plugins=(azure github fluxcd argocd fzf-tab pyenv aliases fzf starship zsh-syntax-highlighting autojump tmux terraform git kubectl docker python helm history golang colored-man-pages ansible zsh-navigation-tools)
