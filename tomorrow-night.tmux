...
set -g status-right '#[fg=#f99157] #{battery_status_bg} Batt: #{battery_icon} #{battery_percentage} #{battery_remain} |#[fg=#6699cc] %a %h-%d %H:%M'
set -g status-left '#[fg=#6699cc] NordVPN: #{nordvpn_status_color}#{nordvpn_status} (#{nordvpn_country}) | #[fg=#f99157] #($TMUX_PLUGIN_MANAGER_PATH/tmux-mem-cpu-load/tmux-mem-cpu-load --interval 2)#[default]'
